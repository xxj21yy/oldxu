...
public class MapperXmlGenerate implements Generate{

    @Override
    public void proess(String modelPath, Filer filer, VelocityContext context, Table table) {
        modelPath = Message.MAPPER_XML_VM_PATH;
        ...
        String outPath = base_path + "/src/main/java/" + mapper_package.replace(".", "/") + "/" + model + "Mapper.xml";
