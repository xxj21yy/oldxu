 ...
 */
//通过二级网址
public class TestBMW2beforeUrl {
    private static Logger logger = LoggerFactory.getLogger(TestBMW2beforeUrl.class);
    int count = 0;
    int downloadCnt = 0;
    int num = 0;
    ...
    public void test() {
        ...
        String s1 = "https://bmw.7zap.com/zh/bmw/e60/530li/";
        ...
        for (Element element1 : select2) {
            ...
            String s38 = "https://bmw.7zap.com/cat_scripts/get_model.php?lang=en&modification=" + a + "&modelname=" + b + "&year=" + yearname + "&wheel=" + wheelname + "&transmission=" + transmissionname + "&classic=VT&region=" + regionname + "&month=" + monthname + "&_=" + jia;
            ...
            if (select8 != null && !"".equals(select8) && select8.size() > 0) {
                ...
                for (Element element3 : label) {
                    ...
                    if (!"btn btn-default disabled".equals(aClass)) {
                        ...
                        String s48 = "https://bmw.7zap.com/cat_scripts/get_model.php?lang=en&modification=" + a + "&modelname=" + b + "&year=" + yearname + "&wheel=" + wheelname + "&transmission=" + transmissionname + "&classic=VT&region=" + regionname + "&month=" + monthname + "&_=" + jia;
                        ...
                        for (Element element5 : label1) {
                            ...
                            if (!"btn btn-default disabled".equals(aClass1)) {
                                ...
                                String s58 = "https://bmw.7zap.com/cat_scripts/get_model.php?lang=en&modification=" + a + "&modelname=" + b + "&year=" + yearname + "&wheel=" + wheelname + "&transmission=" + transmissionname + "&classic=VT&region=" + regionname + "&month=" + monthname + "&_=" + jia;
                                ...
                                for (Element element : label2) {
                                    ...
                                    if (!"btn btn-default disabled".equals(aClass2)) {
                                        ...
                                        String s68 = "https://bmw.7zap.com/cat_scripts/get_model.php?lang=en&modification=" + a + "&modelname=" + b + "&year=" + yearname + "&wheel=" + wheelname + "&transmission=" + transmissionname + "&classic=VT&region=" + regionname + "&month=" + monthname + "&_=" + jia;
                                        ...
                                        for (Element element2 : label3) {
                                            ...
                                            if (!"btn btn-default disabled".equals(aClass3)) {
                                                ...
                                                String s3 = "https://bmw.7zap.com/cat_scripts/get_part_groups.php?lang=zh&modification=" + a + "&modelname=" + b + "&year=" + yearname + "&month=" + monthname + "&wheel=" + wheelname + "&transmission=" + transmissionname + "&classic=VT&region=" + regionname + "&group=" + groupId + "&_=" + jia;
                                                ...
                                                for (Element element111 : select88) {
                                                    ...
                                                    String s33 = "https://bmw.7zap.com/cat_scripts/get_part_subgroups.php?lang=zh&modification=" + a + "&modelname=" + b + "&year=" + yearname + "&month=" + monthname + "&wheel=" + wheelname + "&transmission=" + transmissionname + "&classic=VT&region=" + regionname + "&group=" + groupId + "&_=" + jia;
