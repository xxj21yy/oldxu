 ...
 */
public class TestSkoda {
    private static Logger logger = LoggerFactory.getLogger(TestSkoda.class);
//    int count = 0;//相等
    ...
    public void test() {
        ...
        stringBuilder.append("https://skoda.7zap.com/cn/svw/");//Europa
        String s = "https://skoda.7zap.com/cat_scripts/models_get.php?lang=cn&region=SVW&_=" + jia;
        ...
        try {
            ...
            e.printStackTrace();
            File dir = new File("F:\\Skoda\\bugPath\\ErrorPath.txt");
            try {
        ...
        try {
            for (Element element66 : select4) {
                ...
                if (onclick != null && !"".equals(onclick)) {
                    ...
                    jia++;
                    String s1 = "https://skoda.7zap.com/cat_scripts/part_groups_get.php?lang=cn&region=SVW&modification_date=" + split[3].trim() + "&modification_type=" + split[4].trim() + "&modification_name=" + split[2].trim() + "&model_name=" + split[0].trim() + "&vin=" + split[7].trim() + "&_=" + jia;
                    ...
                    for (Element element : select1) {
                        ...
                        jia++;
                        String s3 = "https://skoda.7zap.com/cat_scripts/part_sub_groups_get.php?lang=cn&region=SVW&modification_date=" + split1[3].trim() + "&modification_type=" + split1[4].trim() + "&modification_name=" + split1[2].trim() + "&model_url=" + split1[1].trim() + "&group_id=" + split1[7].trim() + "&model_name=" + split1[0].trim() + "&vin=" + split1[8].trim() + "&_=" + jia;
                        ...
                        for (Element element77 : select5) {
                            ...
                            if (onclick77 != null && !"".equals(onclick77)) {
                                ...
                                jia++;
                                s8 = "https://skoda.7zap.com/cat_scripts/parts_get.php?lang=cn&region=SVW&modification_date=" + split7[3].trim() + "&modification_type=" + split7[4].trim() + "&modification_name=" + split7[2].trim() + "&model_url=" + split7[1].trim() + "&group_id=" + groupId + "&model_name=" + split7[0].trim() + "&hg_ug=" + split7[8] + "&pnc=" + split7[9].trim() + "&vin=" + split7[10] + "&_=" + jia;
                                s8 = s8.replaceAll("'", "").trim();
                                System.out.println(fileName + " - " + s8);
                                //生成url的txt
//                                count++;
                                count.getAndIncrement();
                                File dir = new File("F:\\Skoda\\path\\" + fileName + "\\" + fileName + "-" + count.get() + ".txt");
                                FileUtils.write(dir, s8, "UTF-8");
                            }
    ...
    public void html() {
        ...
        try {
            ...
            for (int i = 0; i < files.length; i++) {
                ...
                fileName = files[i];
                execcomp.submit(new TestSkoda.Parser2(readfile, fileName));
            }
        } catch(Exception e){
            e.printStackTrace();
        }
            ...
            while (lineIterator.hasNext()) {
                ...
                try {
                    if (imgMap.get(one + "-" + two) == null) {
                        futList.add(fixedThreadPool2.submit(new TestSkoda.Parser3(one, two)));
